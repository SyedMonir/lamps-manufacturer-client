...
import chittagong from '../../assets/image/chittagong.jpg';
    ...
    <section className="text-gray-600 body-font relative mt-4">
      <h1 className="uppercase text-center text-3xl font-bold mt-2 ">
        ...
        <span className="capitalize  tracking-widest text-primary text-base font-medium">
          Our main office address are given below
        </span>
        <br />
      ...
      <div className="container px-5 py-20 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <p className="text-indigo-500 leading-relaxed">
                Rambling.ctg@email.com
              </p>
              <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed">01988-512131</p>
            </div>
          </div>
        </div>
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <button className="text-white bg-primary border-0 py-2 px-6 focus:outline-none hover:shadow-lg rounded text-lg">
            Send
          </button>
        </div>
      </div>
